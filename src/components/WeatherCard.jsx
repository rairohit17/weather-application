...
const WeatherCard = ({ place, windspeed, humidity, temperature, heatIndex, iconString, conditions }) => {
  ...
  return (
    <div className="w-[22rem] min-w-[22rem] h-[30rem] glassCard p-4">
      ...
      <div className="w-full flex justify-between items-center mt-4">
        ...
        <p className="flex-1 text-center p-2">{time.currDate}</p>
      </div>
      ...
      <div className="w-full p-3 mt-4 flex justify-between items-center">
        <p className="text-lg"> Heat Index</p> <span className='font-normal'>{heatIndex ? heatIndex : 'N/A'}</span>
      </div>
